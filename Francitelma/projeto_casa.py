...
produtos = [
    ...
    {'codigo': 5, 'nome': 'Desenvolvimento Web com SQL para Alunos Inteligentes', 'valor': 25.00},
    {'codigo': 6, 'nome': 'Desenvolvimento Web com C++ para Alunos Inteligentes', 'valor': 25.00},
    {'codigo': 7, 'nome': 'Desenvolvimento Web com Java para Alunos Inteligentes', 'valor': 25.00},
...
def calcula_total_desconto(compra):
    ...
    for produto in compra:
        total += (produto['valor'] * produto['quantidade'])
    if total >= 100:                   # regra pra aplicar desconto
     return total * 0.9     # se o valor total de produtos vendidos for igual ou superior a R$100, será aplicado um desconto de 10%, retornando p valor x 0.9 (90%)                                                        
    else: 
     return total         # caso não ultrapasse, será retornado apenas o valor total (valor x quant)
