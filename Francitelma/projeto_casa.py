...
produtos = [
    {'codigo': 1, 'nome': 'Introdução à Computação - Volume 1', 'valor': 40.00},
    {'codigo': 2, 'nome': 'Introdução à Computação - Volume 2', 'valor': 30.00},
    {'codigo': 3, 'nome': 'Linguagens de Programação Web', 'valor': 10.00},
    {'codigo': 4, 'nome': 'Tecnologias de Scripting', 'valor': 50.00},
    {'codigo': 5, 'nome': 'Desenvolvimento Web com SQL', 'valor': 15.00},
    {'codigo': 6, 'nome': 'Desenvolvimento Web com C++', 'valor': 25.00},
    {'codigo': 7, 'nome': 'Desenvolvimento Web com Java', 'valor': 15.00},
    {'codigo': 8, 'nome': 'Desenvolvimento Web com .Net', 'valor': 15.00},
    {'codigo': 9, 'nome': 'Hardware e Redes de Computadores - Volume 1', 'valor': 55.00},
    ...
    {'codigo': 13, 'nome': 'Dominando o Inglês', 'valor': 35.00},
    {'codigo': 14, 'nome': 'Comunicação Empresarial', 'valor': 10.00},
    {'codigo': 15, 'nome': 'Desenvolvimento Pessoal - Livro 1', 'valor': 25.00},
    {'codigo': 16, 'nome': 'Desenvolvimento Pessoal - Livro 2', 'valor': 15.00},
    {'codigo': 17, 'nome': 'Introdução à Computação - Volume 1', 'valor': 20.00},
    {'codigo': 18, 'nome': 'Introdução à Computação - Volume 2', 'valor': 50.00},
    ...
    {'codigo': 22, 'nome': 'Banco de Dados', 'valor': 42.00},
    ...
    {'codigo': 26, 'nome': 'Inteligência Artificial', 'valor': 40.00},
    {'codigo': 27, 'nome': 'Redes de Computadores', 'valor': 15.00},
    {'codigo': 28, 'nome': 'Segurança da Informação', 'valor': 18.00},
    {'codigo': 29, 'nome': 'Administração de Sistemas', 'valor': 35.00},
    {'codigo': 30, 'nome': 'Gestão de Projetos de TI', 'valor': 12.00},
    {'codigo': 31, 'nome': 'Introdução à Estatística', 'valor': 35.00},
    {'codigo': 32, 'nome': 'Probabilidade', 'valor': 30.00},
    ...
    {'codigo': 39, 'nome': 'Biologia', 'valor': 40.00},
    {'codigo': 40, 'nome': 'História', 'valor': 30.00},
    {'codigo': 41, 'nome': 'Geografia', 'valor': 30.00},
    {'codigo': 42, 'nome': 'Sociologia', 'valor': 12.00},
    {'codigo': 43, 'nome': 'Filosofia', 'valor': 20.00},
    ...
    {'codigo': 47, 'nome': 'Literatura Espanhola', 'valor': 30.00},
    {'codigo': 48, 'nome': 'Literatura Francesa', 'valor': 10.00},
    {'codigo': 49, 'nome': 'Literatura Alemã', 'valor': 20.00},
    {'codigo': 50, 'nome': 'Literatura Italiana', 'valor': 10.00},
    {'codigo': 51, 'nome': 'Literatura Russa', 'valor': 40.00},
